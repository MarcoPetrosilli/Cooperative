function main()
    ...
    move_grasped_obj_set={bim_constraint_task, left_joint_limits_task, right_joint_limits_task, left_min_altitude,right_min_altitude,left_tool_task, right_tool_task};
    final_set = {left_min_altitude, right_min_altitude};
    
    
    %Unified task set
    unified_set = {bim_constraint_task, left_joint_limits_task, right_joint_limits_task, left_min_altitude,right_min_altitude,left_tool_task,right_tool_task};
    ...
    for t = 0:dt:end_time
        ...
        StateMachine.update(arm1, arm2, actionManager);
    end
