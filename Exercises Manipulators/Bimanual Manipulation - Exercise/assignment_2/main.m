function main()
    ...
    arm1.setGoal(w_obj_pos,w_obj_ori,w_obj_pos-grasp_offset,rotation(pi, -pi/6, 0));
    arm2.setGoal(w_obj_pos,w_obj_ori,w_obj_pos+grasp_offset,rotation(0, pi+pi/6, 0));
    ...
    if CONSTRAINT_ON 
        ...
        move_grasped_obj_set={bim_constraint_task, left_joint_limits_task, right_joint_limits_task, left_min_altitude,right_min_altitude,left_path_task, right_path_task};
        ...
        unified_set = {bim_constraint_task, left_joint_limits_task, right_joint_limits_task, left_min_altitude,right_min_altitude,left_tool_task,right_tool_task, left_path_task, right_path_task};
        
    else
        % move_grasped_obj_set={left_joint_limits_task, right_joint_limits_task, left_min_altitude,right_min_altitude,left_tool_task_2, right_tool_task_2};
        move_grasped_obj_set={left_joint_limits_task, right_joint_limits_task, left_min_altitude,right_min_altitude,left_path_task, right_path_task};
        % unified_set = {left_joint_limits_task, right_joint_limits_task, left_min_altitude,right_min_altitude,left_tool_task,right_tool_task, left_tool_task_2, right_tool_task_2};
        unified_set = {left_joint_limits_task, right_joint_limits_task, left_min_altitude,right_min_altitude,left_tool_task,right_tool_task, left_path_task, right_path_task};
    end
    ...
    for t = 0:dt:end_time
        ...
        StateMachine.update(arm1, arm2, actionManager, t, bm_sim);
